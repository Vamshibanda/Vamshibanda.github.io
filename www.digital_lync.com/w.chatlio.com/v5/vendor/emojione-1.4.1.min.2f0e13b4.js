/*! emojione 15-04-2015 */ ! function(a) {
    a.emojioneList = {
        ...
        a.jsecapeMap = {
            ...
            "🇦🇮": "1F1E6-1F1EE",
            "🇬🇮": "1F1EC-1F1EE"
        }, a.shortnameRegexp = ":([-+\\w]+):", a.imagePathPNG = "//cdn.jsdelivr.net/emojione/assets/png/", a.imagePathSVG = "//cdn.jsdelivr.net/emojione/assets/svg/", a.imagePathSVGSprites = "./../assets/sprites/emojione.sprites.svg", a.imageType = "png", a.sprites = !1, a.unicodeAlt = !0, a.ascii = !1, a.cacheBustParam = "?v=1.2.4", a.toImage = function(b) {
            ...
            return b = b.replace(new RegExp("<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|(" + a.shortnameRegexp + ")", "gi"), function(b) {
                return "undefined" != typeof b && "" !== b && b in a.emojioneList ? (c = a.emojioneList[b][a.emojioneList[b].length - 1].toLowerCase(), "undefined" != typeof d[c] ? d[c] : b) : b
            })
        }, a.shortnameToUnicode = function(b) {
            var c;
            return b = b.replace(new RegExp("<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|(" + a.shortnameRegexp + ")", "gi"), function(b) {
                return "undefined" != typeof b && "" !== b && b in a.emojioneList ? (c = a.emojioneList[b][a.emojioneList[b].length - 1].toUpperCase(), a.convert(c)) : b
            }), a.ascii && (b = b.replace(new RegExp("<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|((\\s|^)" + a.asciiRegexp + "(?=\\s|$|[!,.]))", "g"), function(b, d, e, f) {
            ...
            var c, d, e;
            return b = b.replace(new RegExp("<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|(" + a.shortnameRegexp + ")", "gi"), function(b) {
                return "undefined" != typeof b && "" !== b && b in a.emojioneList ? (d = a.emojioneList[b][a.emojioneList[b].length - 1].toUpperCase(), e = a.unicodeAlt ? a.convert(d) : b, c = "png" === a.imageType ? a.sprites ? '<span class="emojione-' + d + '" title="' + b + '">' + e + "</span>" : '<img class="emojione" alt="' + e + '" src="' + a.imagePathPNG + d + ".png" + a.cacheBustParam + '"/>' : a.sprites ? '<svg class="emojione"><description>' + e + '</description><use xlink:href="' + a.imagePathSVGSprites + "#emoji-" + d + '"></use></svg>' : '<object class="emojione" data="' + a.imagePathSVG + d + ".svg" + a.cacheBustParam + '" type="image/svg+xml" standby="' + e + '">' + e + "</object>") : b
            }), a.ascii && (b = b.replace(new RegExp("<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|((\\s|^)" + a.asciiRegexp + "(?=\\s|$|[!,.]))", "g"), function(b, f, g, h) {
                return "undefined" != typeof h && "" !== h && a.unescapeHTML(h) in a.asciiList ? (h = a.unescapeHTML(h), d = a.asciiList[h].toUpperCase(), e = a.unicodeAlt ? a.convert(d) : a.escapeHTML(h), c = "png" === a.imageType ? a.sprites ? g + '<span class="emojione-' + d.toUpperCase() + '" title="' + a.escapeHTML(h) + '">' + e + "</span>" : g + '<img class="emojione" alt="' + e + '" src="' + a.imagePathPNG + d + ".png" + a.cacheBustParam + '"/>' : a.sprites ? '<svg class="emojione"><description>' + e + '</description><use xlink:href="' + a.imagePathSVGSprites + "#emoji-" + d.toUpperCase() + '"></use></svg>' : g + '<object class="emojione" data="' + a.imagePathSVG + d + ".svg" + a.cacheBustParam + '" type="image/svg+xml" standby="' + e + '">' + e + "</object>") : b
            })), b
        }, a.unicodeToImage = function(b) {
            var c, d, e;
            if (!a.unicodeAlt || a.sprites) var f = a.mapShortToUnicode();
            return b = b.replace(new RegExp("<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|(" + a.unicodeRegexp + ")", "gi"), function(b) {
                return "undefined" != typeof b && "" !== b && b in a.jsecapeMap ? (d = a.jsecapeMap[b], e = a.unicodeAlt ? a.convert(d) : f[d], c = "png" === a.imageType ? a.sprites ? '<span class="emojione-' + d.toUpperCase() + '" title="' + f[d] + '">' + e + "</span>" : '<img class="emojione" alt="' + e + '" src="' + a.imagePathPNG + d + ".png" + a.cacheBustParam + '"/>' : a.sprites ? '<svg class="emojione"><description>' + e + '</description><use xlink:href="' + a.imagePathSVGSprites + "#emoji-" + d.toUpperCase() + '"></use></svg>' : '<img class="emojione" alt="' + e + '" src="' + a.imagePathSVG + d + ".svg" + a.cacheBustParam + '"/>') : b
            })
        }, a.toShort = function(b) {
            for (var c in a.emojioneList)
                if (a.emojioneList.hasOwnProperty(c))
                    for (var d in a.emojioneList[c])
                        if (a.emojioneList[c].hasOwnProperty(d)) {
                            var e = a.emojioneList[c][d].toUpperCase();
                            b = a.replaceAll(b, a.convert(e), c)
                        }
            return b
        ...
        }, a.mapShortToUnicode = function() {
            var b = {};
            for (var c in a.emojioneList)
                if (a.emojioneList.hasOwnProperty(c))
                    for (var d in a.emojioneList[c]) a.emojioneList[c].hasOwnProperty(d) && (b[a.emojioneList[c][d].toUpperCase()] = c);
            return b
            ...
            var d = new RegExp("<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|(" + b + ")", "gi"),
                e = function(a, b) {
                    return "undefined" == typeof b || "" === b ? a : c
                };
